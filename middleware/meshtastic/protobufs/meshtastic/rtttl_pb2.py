...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'meshtastic.rtttl_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RTTTLCONFIG']._serialized_start=38
  _globals['_RTTTLCONFIG']._serialized_end=69
