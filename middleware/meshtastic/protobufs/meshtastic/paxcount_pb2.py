...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'meshtastic.paxcount_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PAXCOUNT']._serialized_start=41
  _globals['_PAXCOUNT']._serialized_end=94
