...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'meshtastic.portnums_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PORTNUM']._serialized_start=42
  _globals['_PORTNUM']._serialized_end=629
